                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 my-3">
                            <div class="card p-4">
                                <iframe style="width: 100%" width="560" height="315" src="https://www.youtube.com/embed/{{ getYoutubeId($row->video) }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
