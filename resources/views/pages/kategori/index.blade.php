    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="main-body">
                <form id="formKategori" action="{{ URL::to('/dosen/create_kategori') }}" method="POST">
                    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('.table-kategori tbody').on('click', 'tr td a.edit', function() {
            ...
            $('#formKategori').attr('action','/dosen/update_kategori')
        })

        // TOMBOL TAMBAH USER
        $('#addUserBtn').on('click', function() {
            $('#formKategori').attr('action','/dosen/create_kategori')
        });
